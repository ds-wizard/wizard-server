...
_ERROR_SERVICE_CONFIG__VALIDATION_DATABASE_MAX_CONNECTIONS =
  "Invalid configuration supplied: database.stripeSize * database.maxConnections must be at least 8"
