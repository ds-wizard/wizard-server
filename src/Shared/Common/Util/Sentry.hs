...
data AppContextException = AppContextException
...
instance Show AppContextException where
  show carried = show carried.appException

instance Exception AppContextException

throwWithAppContext :: AppContextException -> IO a
throwWithAppContext = throwIO

unwrapException :: SomeException -> SomeException
unwrapException exception =
  case toAppContextException exception of
    Just carried -> carried.appException
    Nothing -> exception

toAppContextException :: SomeException -> Maybe AppContextException
toAppContextException = fromException
...
toWebServerEvent getSentryIdentity mRequest wrapped =
  let event = toRequestEvent getSentryIdentity mRequest (unwrapException wrapped)
   in case toAppContextException wrapped of
        Just carried -> enrichWithAppContext event carried
        Nothing -> event

enrichWithAppContext :: SentryEvent -> AppContextException -> SentryEvent
enrichWithAppContext event carried =
  event
