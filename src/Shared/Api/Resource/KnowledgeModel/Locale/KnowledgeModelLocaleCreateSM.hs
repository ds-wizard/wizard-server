module Shared.Api.Resource.KnowledgeModel.Locale.KnowledgeModelLocaleCreateSM where
...
import Shared.Api.Resource.KnowledgeModel.Locale.KnowledgeModelLocaleCreateDTO (KnowledgeModelLocaleCreateDTO)
