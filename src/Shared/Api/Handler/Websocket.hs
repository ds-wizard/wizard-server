module Shared.Api.Handler.Websocket where
...
initConnection :: WizardRequestContextC s m => m U.UUID
initConnection = do
...
handleWebsocketMessage
  :: (WizardRequestContextC s m, FromJSON reqDto)
  => String
  -> U.UUID
  -> Connection
  -> m ()
...
log :: WizardRequestContextC s m => U.UUID -> String -> m ()
