module Shared.Service.Owl.Diff.Differ (
  diffKnowledgeModel,
) where
...
import Shared.Service.Owl.Diff.EventFactory.Answer ()
import Shared.Service.Owl.Diff.EventFactory.Chapter ()
import Shared.Service.Owl.Diff.EventFactory.Choice ()
import Shared.Service.Owl.Diff.EventFactory.EventFactory
import Shared.Service.Owl.Diff.EventFactory.Question ()
