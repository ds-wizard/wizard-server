module Shared.Service.Config.Integration.IntegrationConfigService where
...
getFileIntegrationConfig :: WizardRequestContextC s m => String -> m (M.Map String String)
