module Shared.Service.KnowledgeModel.Squash.Squasher where
...
import Shared.Service.KnowledgeModel.Squash.Event.Event
import Shared.Util.List (groupBy, replace)
