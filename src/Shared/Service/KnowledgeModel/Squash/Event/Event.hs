module Shared.Service.KnowledgeModel.Squash.Event.Event where

import Shared.Model.KnowledgeModel.Event.KnowledgeModelEvent
import Shared.Service.KnowledgeModel.Squash.Event.Answer ()
import Shared.Service.KnowledgeModel.Squash.Event.Chapter ()
import Shared.Service.KnowledgeModel.Squash.Event.Choice ()
import Shared.Service.KnowledgeModel.Squash.Event.Common
import Shared.Service.KnowledgeModel.Squash.Event.Expert ()
import Shared.Service.KnowledgeModel.Squash.Event.Integration ()
import Shared.Service.KnowledgeModel.Squash.Event.KnowledgeModel ()
import Shared.Service.KnowledgeModel.Squash.Event.Metric ()
import Shared.Service.KnowledgeModel.Squash.Event.Phase ()
import Shared.Service.KnowledgeModel.Squash.Event.Question ()
import Shared.Service.KnowledgeModel.Squash.Event.Reference ()
import Shared.Service.KnowledgeModel.Squash.Event.Resource ()
import Shared.Service.KnowledgeModel.Squash.Event.Tag ()
