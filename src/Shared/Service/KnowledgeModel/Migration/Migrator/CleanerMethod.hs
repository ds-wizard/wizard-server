module Shared.Service.KnowledgeModel.Migration.Migrator.CleanerMethod where
...
runCleanerMethod :: WizardRequestContextC s m => KnowledgeModelMigration -> KnowledgeModelEvent -> m KnowledgeModelMigration
