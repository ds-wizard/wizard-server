module Shared.Service.KnowledgeModel.Migration.Migrator.Migrator where
...
import Shared.Service.KnowledgeModel.Migration.Migrator.CleanerMethod
import Shared.Service.KnowledgeModel.Migration.Migrator.CorrectorMethod

migrate :: WizardRequestContextC s m => KnowledgeModelMigration -> m KnowledgeModelMigration
migrate state =
  case state.state of
...
doMigrate :: WizardRequestContextC s m => m KnowledgeModelMigration -> KnowledgeModelEvent -> m KnowledgeModelMigration
