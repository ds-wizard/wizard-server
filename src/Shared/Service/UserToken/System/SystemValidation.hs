module Shared.Service.UserToken.System.SystemValidation where
...
decodeAndValidateJwtToken :: WizardRequestContextC s m => String -> [JWK.Jwk] -> Integer -> UTCTime -> m (Either LocaleRecord UserTokenClaimsDTO)
