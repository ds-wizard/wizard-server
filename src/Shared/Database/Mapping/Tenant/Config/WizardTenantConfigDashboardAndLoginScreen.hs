module Shared.Database.Mapping.Tenant.Config.WizardTenantConfigDashboardAndLoginScreen where
...
import Shared.Database.Mapping.Tenant.Config.TenantConfigDashboardAndLoginScreen ()
