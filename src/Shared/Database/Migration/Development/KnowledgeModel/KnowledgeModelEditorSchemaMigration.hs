module Shared.Database.Migration.Development.KnowledgeModel.KnowledgeModelEditorSchemaMigration where
...
createKnowledgeModelEditorTable :: WizardRequestContextC s m => m Int64
...
createKnowledgeModelEditorEventTable :: WizardRequestContextC s m => m Int64
...
createKnowledgeModelEditorReplyTable :: WizardRequestContextC s m => m Int64
