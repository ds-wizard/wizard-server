module Shared.Database.Migration.Development.Project.ProjectSchemaMigration where
...
dropTables = do
  ...
  let sql =
        "DROP TABLE IF EXISTS project_cache CASCADE; \
...
createProjectTable :: WizardRequestContextC s m => m Int64
...
createProjectEventTable :: WizardRequestContextC s m => m Int64
...
createProjectPermUserTable :: WizardRequestContextC s m => m Int64
...
createProjectPermGroupTable :: WizardRequestContextC s m => m Int64
...
createProjectCommentThreadTable :: WizardRequestContextC s m => m Int64
...
createProjectCommentTable :: WizardRequestContextC s m => m Int64
...
createProjectVersionTable :: WizardRequestContextC s m => m Int64
...
createProjectFileTable :: WizardRequestContextC s m => m Int64
...
createProjectCacheTable :: WizardRequestContextC s m => m Int64
createProjectCacheTable = do
  logInfo _CMP_MIGRATION "(Table/ProjectCache) create table"
  let sql =
...
createPersistentCommandFromProjectFileDeleteFunction :: WizardRequestContextC s m => m Int64
