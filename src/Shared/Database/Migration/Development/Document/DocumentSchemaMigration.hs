module Shared.Database.Migration.Development.Document.DocumentSchemaMigration where
...
createDocumentTable :: WizardRequestContextC s m => m Int64
...
createPersistentCommandFromDocumentDeleteFunction :: WizardRequestContextC s m => m Int64
