...
instance FromField ProjectEventType where
  fromField f mdata = do
    ...
    case mdata of
      Just bs | typename == "w_project_event_type" ->
        case bs of
      ...
      _ -> returnError Incompatible f "Expected w_project_event_type ENUM"
    ...
    case mdata of
      Just bs ->
        case bs of
          ...
          _ -> returnError ConversionFailed f "Invalid ENUM value"
      _ -> returnError Incompatible f "Expected w_value_type ENUM"
