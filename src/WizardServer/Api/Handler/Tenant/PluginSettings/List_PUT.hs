module WizardServer.Api.Handler.Tenant.PluginSettings.List_PUT where
...
list_PUT :: WizardHandlerC s sm r rm => Maybe String -> Maybe String -> M.Map U.UUID Bool -> sm (Headers '[Header "x-trace-uuid" String] NoContent)
