module WizardServer.Service.Config.Client.ClientConfigService where
...
getClientConfig :: WizardRequestContextC s m => Maybe String -> Maybe String -> m ClientConfigDTO
