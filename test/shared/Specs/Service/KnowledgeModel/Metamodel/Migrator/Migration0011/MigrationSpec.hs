module Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0011.MigrationSpec (
  spec,
) where
...
import Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0011.MigrationFixtures as Fixtures
