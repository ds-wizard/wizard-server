module Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0010.MigrationSpec (
  spec,
) where
...
import Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0010.MigrationFixtures as Fixtures
