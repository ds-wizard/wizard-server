module Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0002.MigrationSpec (
  spec,
) where
...
import Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0002.MigrationFixtures as Fixtures
import Specs.Service.KnowledgeModel.Metamodel.Migrator.TestFixtures as Fixtures

import Shared.Service.KnowledgeModel.Metamodel.Migrator.EventMigrator as EventMigrator
