module Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0016.MigrationSpec (
  spec,
) where
...
import Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0016.MigrationFixtures as Fixtures
