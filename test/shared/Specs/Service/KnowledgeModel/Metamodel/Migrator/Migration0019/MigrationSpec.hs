module Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0019.MigrationSpec (
  spec,
) where
...
import Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0019.MigrationFixtures as Fixtures
