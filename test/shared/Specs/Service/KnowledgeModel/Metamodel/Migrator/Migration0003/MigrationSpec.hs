module Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0003.MigrationSpec (
  spec,
) where
...
import Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0003.MigrationFixtures as Fixtures
