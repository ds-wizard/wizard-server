module Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0017.MigrationSpec (
  spec,
) where
...
import Specs.Service.KnowledgeModel.Metamodel.Migrator.Migration0017.MigrationFixtures as Fixtures
