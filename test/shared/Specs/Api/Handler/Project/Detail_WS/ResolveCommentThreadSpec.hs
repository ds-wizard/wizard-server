module Specs.Api.Handler.Project.Detail_WS.ResolveCommentThreadSpec where
...
resolveCommentThreadSpec requestContext = describe "resolveCommentThread" $ test200 requestContext
